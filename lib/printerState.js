...
const PrinterStatus = {
  ...
  [PrinterStates.PREPARING]: 'Printer is preparing a server print',
  [PrinterStates.PRINTING]: 'Printer is printing a server print',
  ...
  [PrinterStates.CANCELING]: 'Printer is canceling a print from the server',
  [PrinterStates.COMPLETE]: 'Printer has completed a print from the server',
